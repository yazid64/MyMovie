...
public class Adapter_upcoming extends RecyclerView.Adapter<Adapter_upcoming.MyViewHolder>{
    ...
    @NonNull
    @Override
    public Adapter_upcoming.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v;
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_upcoming.MyViewHolder holder, int position) {
