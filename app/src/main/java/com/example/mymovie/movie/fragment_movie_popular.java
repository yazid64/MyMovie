...
import com.example.mymovie.MovieModel.Adapter_popular;
...
public class fragment_movie_popular extends Fragment {
    ...
    ArrayList<modelUpcoming> populars = new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)v.findViewById(R.id.rv_movie_popular);
        swipeLayout =v.findViewById(R.id.swipe_movie_popular);
        fetchJobs();
...
//                Toast.makeText(getApplicationContext(), "Job is Up to date!", Toast.LENGTH_SHORT).show();// Delay in millis
        ...
        recyclerViewAdapter = new Adapter_popular(getContext(),populars);
        recyclerView.setLayoutManager(new GridLayoutManager(getContext(),3));
        recyclerView.setAdapter(recyclerViewAdapter);
        return v;
    } private void fetchJobs() {
        AndroidNetworking.get("https://api.themoviedb.org/3/movie/popular?api_key=c55707e61472f37ee6d234e3d5171e4c&language=en-US&page=1")
                .setTag("results")
