...
public class fragment_tvshow_ontheair extends Fragment {
    ...
    private Adapter_ontheair recyclerViewAdapter;
    //    List<model> lstmodel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)v.findViewById(R.id.rv_tv_ontheair);
        swipeLayout =v.findViewById(R.id.swipe_tv_ontheair);
        fetchJobs();
...
//                Toast.makeText(getApplicationContext(), "Job is Up to date!", Toast.LENGTH_SHORT).show();// Delay in millis
        ...
        recyclerViewAdapter = new Adapter_ontheair(getContext(),arrayList);
    ...
    private void fetchJobs() {
        AndroidNetworking.get("https://api.themoviedb.org/3/tv/on_the_air?api_key=c55707e61472f37ee6d234e3d5171e4c&language=en-US&page=1")
                .setTag("results")
