...
import com.example.mymovie.Tvmodel.Adapter_ontheair;
...
public class fragment_tvshow_populer extends Fragment {

    View v;
    private RecyclerView recyclerView;
    private Adapter_popular recyclerViewAdapter;
    SwipeRefreshLayout swipeLayout;
    ArrayList<Tvshow> arrayList = new ArrayList<>();
    public fragment_tvshow_populer(){
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.activity_fragment_tvshow_populer,container,false);
        recyclerView = (RecyclerView)v.findViewById(R.id.rv_tv_popular);
        swipeLayout =v.findViewById(R.id.swipe_tv_popular);
        fetchJobs();
...
//                Toast.makeText(getApplicationContext(), "Job is Up to date!", Toast.LENGTH_SHORT).show();// Delay in millis
        ...
        recyclerViewAdapter = new Adapter_popular(getContext(),arrayList);
    ...
    private void fetchJobs() {
        AndroidNetworking.get("https://api.themoviedb.org/3/tv/popular?api_key=c55707e61472f37ee6d234e3d5171e4c&language=en-US&page=1")
                .setTag("results")
