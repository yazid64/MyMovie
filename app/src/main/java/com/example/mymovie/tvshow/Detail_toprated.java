...
Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_toprated2);

        toolbar = findViewById(R.id.toolbar_toprated);
        original_title = findViewById(R.id.originaltitle_tv_toprated);
        vote = findViewById(R.id.voteaverage_tv_toprated);
        release = findViewById(R.id.release_tv_toprated);
        popularity = findViewById(R.id.popularity_tv_toprated);
        img =  findViewById(R.id.img_tv_toprated);
        overview = findViewById(R.id.overview_tv_toprated);
        language = findViewById(R.id.language_tv_toprated);
